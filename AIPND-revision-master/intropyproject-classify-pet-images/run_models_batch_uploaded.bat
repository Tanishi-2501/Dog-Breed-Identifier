...
REM 
@echo on
python AIPND-revision-master\intropyproject-classify-pet-images\check_images.py --dir uploaded_images/ --arch resnet  --dogfile dognames.txt > resnet_uploaded-images.txt
python AIPND-revision-master\intropyproject-classify-pet-images\check_images.py --dir uploaded_images/ --arch alexnet --dogfile dognames.txt > alexnet_uploaded-images.txt
python AIPND-revision-master\intropyproject-classify-pet-images\check_images.py --dir uploaded_images/ --arch vgg  --dogfile dognames.txt > vgg_uploaded-images.txt
